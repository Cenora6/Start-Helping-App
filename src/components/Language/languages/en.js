const en = {
    ...
    stepsHeader: "4 simple steps are enough",
    ...
    stepsMain6: "clothes, toys, equipment and other things",
    ...
    giveThingsHeader2: "4 simple steps are enough",
    giveThingsHeader3a: "Choose",
    giveThingsHeader3b: "things",
    giveThingsHeader4a: "Pack them",
    giveThingsHeader4b: "in the bags",
    giveThingsHeader5a: "Choose an",
    giveThingsHeader5b: "organization",
    giveThingsHeader6a: "Book",
    giveThingsHeader6b: "a courier",
    ...
    step7: "Important!",
    step8: "Complete the details of your things. We will know, who should we donate them to.",
